...
class Projection {
public:
    Projection(qreal start, qreal end): m_start(start), m_end(end) { }
...
public:
    ...
    BaseDesignIntf* addReportItem(const QString& itemType, QObject* owner = 0,
                                  BaseDesignIntf* parent = 0);
    BaseDesignIntf* createReportItem(const QString& itemType, QObject* owner = 0,
                                     BaseDesignIntf* parent = 0);
    ...
    void changeSelectedGrpoupTextAlignPropperty(const bool& horizontalAlign,
...
protected:
    ...
    LimeReport::BandDesignIntf::BandsType
    findPriorType(LimeReport::BandDesignIntf::BandsType bandType);
...
public slots:
    ...
    void setBordersExt(const BaseDesignIntf::BorderLines& border, const double borderWidth,
                       const BaseDesignIntf::BorderStyle style, const QString color);
    void lockSelectedItems();
    void unlockSelectedItems();
    void selectOneLevelItems();
private slots:
    void slotPageGeometryChanged(QObject*, QRectF, QRectF);
    void slotItemPropertyChanged(QString propertyName, const QVariant& oldValue,
...
private:
    template <typename T> BaseDesignIntf* internalAddBand(T bandType);
...
public:
    static CommandIf::Ptr create(PageDesignIntf* page, const QString& itemType, QPointF pos,
                                 QSizeF size);
    bool doIt();
    void undoIt();
...
public:
    static CommandIf::Ptr create(PageDesignIntf* page, const QString& itemsXML,
...
public:
    static CommandIf::Ptr create(PageDesignIntf* page, QVector<ReportItemPos>& oldPos,
...
public:
    static CommandIf::Ptr create(PageDesignIntf* page, QVector<ReportItemSize>& oldSize,
...
public:
    static CommandIf::Ptr create(PageDesignIntf* page, const QString& objectName,
...
public:
    static CommandIf::Ptr create(PageDesignIntf* page, const QString& oldValue,
