...
public:
  ...
  ScriptEngineNode(const QString &name = "",
                   const QString &description = "",
                   NodeType type = Root,
                   ScriptEngineNode *parent = 0,
  ...
  ScriptEngineNode *addChild(const QString &name = "",
                             const QString &description = "",
                             NodeType type = Root,
                             const QIcon &icon = QIcon());
  int row();
...
public:
  ...
  JSFunctionDesc(const QString &functionName,
      ...
      : m_name(functionName), m_category(functionCategory), m_description(functionDescription),
        m_managerName(functionManagerName), m_manager(functionManager),
...
class ComboBoxWrapper : public QObject {
  Q_OBJECT
public:
  ComboBoxWrapper(QComboBox *comboBox, QObject *parent = 0)
...
public:
  ...
  ~ScriptFunctionsManager() {
    foreach(IWrapperCreator *wrapper, m_wrappersFactory.values()) { delete wrapper; }
    m_wrappersFactory.clear();
  }
  Q_INVOKABLE QVariant calcGroupFunction(const QString &name,
  ...
  Q_INVOKABLE QVariant numberFormat(QVariant value,
                                    const char &format,
                                    int precision,
  ...
  Q_INVOKABLE QFont font(const QString &family,
                         int pointSize = -1,
                         bool bold = false,
                         bool italic = false,
...
public:
  ...
  QString expandUserVariables(QString context,
                              RenderPass pass,
  ...
  QString replaceScripts(QString context,
                         QVariant &varValue,
                         QObject *reportItem,
                         ScriptEngineType *se,
