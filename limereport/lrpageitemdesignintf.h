...
class LIMEREPORT_EXPORT PageItemDesignIntf: public ItemsContainerDesignInft {
    ...
    Q_PROPERTY(
        bool isExtendedInDesignMode READ isExtendedInDesignMode WRITE setExtendedInDesignMode)
...
public:
    ...
    explicit PageItemDesignIntf(const PageSize pageSize, const QRectF& rect, QObject* owner = 0,
    ...
    int calcBandIndex(BandDesignIntf::BandsType bandType, BandDesignIntf* parentBand,
                      bool& increaseBandIndex);
