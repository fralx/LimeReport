...
public:
  ...
  void addSubQuery(const QString &name,
  ...
  void addCSV(const QString &name,
  ...
  void addVariable(const QString &name,
                   ...
                   VarDesc::VarType type = VarDesc::User,
                   RenderPass pass = FirstPass);
  ...
  GroupFunction *addGroupFunction(const QString &name,
